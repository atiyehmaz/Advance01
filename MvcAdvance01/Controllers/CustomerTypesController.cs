...
namespace MvcAdvance01.Controllers
{
    public class CustomerTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Title,Discription")] CustomerType customerType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Title,Discription")] CustomerType customerType)
        {
            if (ModelState.IsValid)
            {
